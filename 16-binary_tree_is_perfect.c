...
int binary_tree_is_perfect(const binary_tree_t *tree)
{
	...
	int left_height = _get_left_subtree_height(tree);
	int right_height = _get_right_subtree_height(tree);
...
int _get_left_subtree_height(const binary_tree_t *tree)
{
	...
	return (_get_left_subtree_height(tree->left) + 1);
}
...
int _get_right_subtree_height(const binary_tree_t *tree)
{
	...
	return (_get_right_subtree_height(tree->right) + 1);
}
